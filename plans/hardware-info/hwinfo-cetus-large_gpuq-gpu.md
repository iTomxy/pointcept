...
- **host:** hpc-exec19.hpc.uts.edu.au
- **collected:** 2026-08-26T16:41:51+10:00
- **user:** u24647087
- **in scheduler job:** 66618.hpc-head01
...
- **model:** AMD EPYC 9255 24-Core Processor
- **sockets x cores x threads:** 1 24 2 
- **logical cpus:** 4
- **total ram:** 377Gi
...
0, NVIDIA RTX PRO 6000 Blackwell Server Edition, 12.0, 97887 MiB, 580.142, Default, Disabled
1, NVIDIA RTX PRO 6000 Blackwell Server Edition, 12.0, 97887 MiB, 580.142, Default, Disabled
```
- **gpu count:** 2
...
/dev/nvme1n1p5             1.8T  492G  1.3T  28% /
/dev/nvme1n1p3              16G  2.4G   14G  15% /var
/dev/nvme0n1p1             3.5T  688G  2.9T  20% /scratch
```
- **quota:** n/a
- **home is network fs:** nfs4
- **TMPDIR:** /var/tmp/pbs.66618.hpc-head01
...
smallq               0     0 yes yes     0     0     0     0     0     0 Exe*
workq                0    48 yes yes     0    38     2     0     0     0 Exe*
iworkq               0    19 yes yes     8     1     0    10     0     0 Exe*
small_gpuq           0    17 yes yes    11     3     3     0     0     0 Exe*
med_gpuq             0    12 yes yes     9     2     1     0     0     0 Exe*
large_gpuq           0    43 yes yes     9    27     5     0     0     0 Exe*
